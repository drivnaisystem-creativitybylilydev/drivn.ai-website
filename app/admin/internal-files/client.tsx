...
export default function ClientPage({ initialDocs }: { initialDocs: DocFile[] }) {
  const [selectedDoc, setSelectedDoc] = useState(initialDocs[0]?.name || "");
  const currentDoc = initialDocs.find((d) => d.name === selectedDoc);
