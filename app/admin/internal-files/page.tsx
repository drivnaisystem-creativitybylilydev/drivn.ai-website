...
`,
  ...
  {
    name: "interview-recording-guide",
    title: "Interview Recording & Transcription Workflow",
    description: "Step-by-step guide for recording market research interviews and transcribing audio",
    category: "sales",
    content: `# Interview Recording & Transcription Workflow

## Overview

Conducting market research interviews to understand pain points in a niche. This guide covers: setup → recording → transcription → analysis.
...
**Enable Voice Memos Recording:**
- Settings → Privacy → Microphone → Allow Voice Memos access
- Test a quick recording to ensure audio quality

**Why Voice Memos?**
- Built-in to iPhone, free, no setup
- Audio quality is good for transcription
- Easy to upload and share

---

### 2. Prepare Your Questionnaire

**Use the Interview Questionnaire Form**
- Go to \`/admin/interview-questionnaire\` on your dashboard
- Download as PDF/text
- Print or open on tablet during the call
- Take notes directly on the form
...
**Setup:**
- Place iPhone on a table with Voice Memos open
- Position microphone 12-18 inches from interviewee

**Start Recording:**
- Hit the red record button
- State: "I'm recording this conversation for research purposes. Is that okay?"

**During the Call:**
- Let them talk (don't interrupt)
- Take notes on timestamps of important points
- Write down their top 3 pain points

**End Recording:**
- Hit stop when the call ends
- Name the file: "Interview-[CompanyName]-[Date]"

---

## AFTER THE INTERVIEW: TRANSCRIPTION OPTIONS

### Option 1: Apple Transcription (Free, iOS 17+)

**Best for:** Zero friction, want results immediately

**Steps:**
1. Open Voice Memos
2. Find your recording
3. Tap "Transcribe" button
4. Wait 30-60 seconds
5. Read transcript in Voice Memos

**Pros:** Free, fast, private (on-device)
**Cons:** iOS 17+ only, ~90% accuracy

---

### Option 2: Otter.ai (Free Tier) ✓ RECOMMENDED

**Best for:** Very accurate, works on any device

**Steps:**
1. Go to otter.ai
2. Create free account (600 min/month)
3. Import your Voice Memos recording
4. Otter transcribes within 5 minutes
5. Read/edit transcript in app

**Pros:** ~95% accuracy, free tier generous, searchable, shareable
**Cons:** Requires account, processes on their servers

**For your professor interview: Sign up before the call, upload right after. Transcription done by noon.**

---

### Option 3: Rev.com (Premium)

**Cost:** ~$1.25/min (~$18.75 for 15-min interview)
**Best for:** Critical interviews requiring perfect accuracy
...
1. Read through transcript and highlight key sections
2. Write down top 3 pain points mentioned
3. Estimate monthly impact for each pain point
4. Identify AI solutions that could address each
5. Note referral potential ("Can you introduce me to other CPAs?")
6. Grade the niche (Is this viable for Drivn.AI?)

---

## EXAMPLE WORKFLOW

1. **Before call:** Open Voice Memos, have Interview Questionnaire printed
2. **During call:** Record audio, take notes, capture timestamps
3. **After call:** Upload to Otter.ai, transcription complete in 5 minutes
4. **Same day:** Read transcript, highlight pain points
5. **Next day:** Decide if niche is viable
...
| Factor | Score |
|--------|-------|
| 3+ solid pain points | +3 |
| Monthly opportunity >$5K | +2 |
| Receptive to AI | +2 |
| Industry-wide problem | +2 |
| Can solve with current tech | +2 |
| Referral potential (5+) | +2 |
| **If 10+:** Worth pursuing |
| **If 5-9:** Needs more validation |
| **If <5:** Stick to home services |

---

## NEXT STEPS

1. Conduct interview tomorrow
2. Transcribe by tomorrow afternoon
3. Fill out decision matrix
4. Decide: Viable for Drivn.AI?
5. If yes → plan 2-3 more interviews
6. If no → focus on home services

---

**Use the Interview Questionnaire form at \`/admin/interview-questionnaire\` to guide your call.**
\`,
  },
];
