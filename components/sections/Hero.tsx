      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 py-24 text-center">
        ...
        >
          <motion.h1
            ...
            className="max-w-3xl mx-auto leading-tight flex flex-col items-center gap-2"
          >
          ...
          <motion.div variants={fadeInFromBottom} className="space-y-4 max-w-3xl mx-auto mb-8 flex flex-col items-center">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl font-inter text-white font-medium pt-8 md:pt-10 text-center w-full max-w-3xl mx-auto">
