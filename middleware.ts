...
export const config = {
  matcher: [
    ...
    "/((?!api|_next|admin(?:/|$)|consultant(?:/|$)|p(?:/|$)|afrodita-call-prep|afrodita-proposal|afrodita-offer|sheridan-movers|bellah-moving|allset-moving|moving-and-logistics|_vercel|work/notime-storage/questionnaire|.*\\..*).*)",
  ],
};
